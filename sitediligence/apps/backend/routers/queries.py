        ...
        "results": [
            ...
            },
            {
                ...
                "data": {
                    ...
                    "review": True,
                    "dominant_class": 22,
                    "dominant_name": "Developed, Low Intensity",
                    "dominant_color": "#D99282",
                    "dominant_pct": 52.0,
                    "sample_count": 25,
                    "grid_size": 5,
                    "class_breakdown": [
                        {"code": 22, "name": "Developed, Low Intensity",    "group": "Developed",  "color": "#D99282", "count": 13, "pct": 52.0},
                        {"code": 21, "name": "Developed, Open Space",       "group": "Developed",  "color": "#DDC9C9", "count":  7, "pct": 28.0},
                        {"code": 23, "name": "Developed, Medium Intensity", "group": "Developed",  "color": "#D0021B", "count":  3, "pct": 12.0},
                        {"code": 31, "name": "Barren Land",                 "group": "Barren",     "color": "#B2ADA3", "count":  2, "pct":  8.0},
                    ],
                    "group_summary": {"Developed": 23, "Barren": 2},
                    "all_classes": [
                        {"code": 11, "name": "Open Water",                  "group": "Water",       "color": "#476BA1"},
                        {"code": 12, "name": "Perennial Ice/Snow",           "group": "Water",       "color": "#D1DDF9"},
                        {"code": 21, "name": "Developed, Open Space",        "group": "Developed",   "color": "#DDC9C9"},
                        {"code": 22, "name": "Developed, Low Intensity",     "group": "Developed",   "color": "#D99282"},
                        {"code": 23, "name": "Developed, Medium Intensity",  "group": "Developed",   "color": "#D0021B"},
                        {"code": 24, "name": "Developed, High Intensity",    "group": "Developed",   "color": "#AA0000"},
                        {"code": 31, "name": "Barren Land",                  "group": "Barren",      "color": "#B2ADA3"},
                        {"code": 41, "name": "Deciduous Forest",             "group": "Forest",      "color": "#6EA966"},
                        {"code": 42, "name": "Evergreen Forest",             "group": "Forest",      "color": "#1D6330"},
                        {"code": 43, "name": "Mixed Forest",                 "group": "Forest",      "color": "#B5C98E"},
                        {"code": 51, "name": "Dwarf Scrub",                  "group": "Shrubland",   "color": "#CCB879"},
                        {"code": 52, "name": "Shrub/Scrub",                  "group": "Shrubland",   "color": "#CCBA7C"},
                        {"code": 71, "name": "Grassland/Herbaceous",         "group": "Herbaceous",  "color": "#E2E2C1"},
                        {"code": 72, "name": "Sedge/Herbaceous",             "group": "Herbaceous",  "color": "#D0D181"},
                        {"code": 73, "name": "Lichens",                      "group": "Herbaceous",  "color": "#A4CC51"},
                        {"code": 74, "name": "Moss",                         "group": "Herbaceous",  "color": "#82BA9E"},
                        {"code": 81, "name": "Pasture/Hay",                  "group": "Agriculture", "color": "#DDD75C"},
                        {"code": 82, "name": "Cultivated Crops",             "group": "Agriculture", "color": "#AE7229"},
                        {"code": 90, "name": "Woody Wetlands",               "group": "Wetlands",    "color": "#BBD7ED"},
                        {"code": 95, "name": "Emergent Herbaceous Wetlands", "group": "Wetlands",    "color": "#71A4C1"},
                    ],
                    "display": {
                        "wms_url": "https://www.mrlc.gov/geoserver/mrlc_display/NLCD_2021_Land_Cover_L48/ows",
                        "wms_layer": "NLCD_2021_Land_Cover_L48",
                        "opacity": 0.6,
                        "flag_classes": [90, 95],
                        "note": "",
                    },
                    ...
                    "transmission_lines": [
                        {
                            ...
                            "coordinates": [
                                [[-104.908, 39.692], [-104.906, 39.695], [-104.903, 39.698], [-104.900, 39.701]],
                            ],
                        },
                        {
                            "id": "2601235",
                            ...
                            "category": "transmission",
                            "coordinates": [
                                [[-104.902, 39.693], [-104.901, 39.697], [-104.899, 39.701], [-104.897, 39.706]],
                            ],
                        },
                        {
                            "id": "2601236",
                            "owner": "Tri-State G&T Association",
                            "voltage_kv": 115.0,
                            "type": "AC",
                            "status": "In Service",
                            "color": "#F59E0B",
                            "category": "transmission",
                            "coordinates": [
                                [[-104.897, 39.694], [-104.895, 39.698], [-104.894, 39.703]],
                            ],
                        },
                    ],
                    "voltage_summary": {
                    ...
                    "placeholder_layers": [
                        {
                            ...
                            "weight": 2,
                            "enabled": False,
                            "note": "Add ArcGIS REST URL for natural gas pipeline data. HIFLD interstate/intrastate pipelines are available at: https://services1.arcgis.com/Hp6G80Pky0om7QvQ/arcgis/rest/services/Natural_Gas_Interstate_and_Intrastate_Pipelines/FeatureServer/0/query",
                            "source": None,
                        },
                        {
                            "id": "water",
                            ...
                            "weight": 2,
                            "enabled": False,
                            "note": "Add municipal or county water authority GIS endpoint. Many utilities publish ArcGIS REST or WFS services — contact the local water authority for access.",
                            "source": None,
                        },
                        {
                            "id": "sewer",
                            ...
                            "weight": 2,
                            "enabled": False,
                            "note": "Add municipal or county sanitary sewer authority GIS endpoint. Storm and sanitary sewer layers may be published separately.",
                            "source": None,
                        },
                        {
                            "id": "telecom",
                            ...
                            "weight": 1.5,
                            "enabled": False,
                            "note": "Add FCC broadband deployment data or telecom provider GIS endpoint. FCC National Broadband Map: https://broadbandmap.fcc.gov/",
                            "source": None,
                        },
                    ],
                    "error": None,
                    "display": {
                        "color_transmission": "#F59E0B",
                        "color_gas": "#F97316",
                        "color_water": "#3B82F6",
                        "color_sewer": "#92400E",
